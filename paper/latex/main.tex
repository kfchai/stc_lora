...
\begin{table}[t]
\centering\small
\caption{Domain-incremental CL at 0.5B: mean $\pm$ std over 4 (seed, order) replicates. Joint ceiling: 45.0 ppl. $^{\dagger}$A-GEM: single run (seed 0, order A).}
\label{tab:main}
\begin{tabular}{lcc}
\toprule
